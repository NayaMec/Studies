...
<div> <p>Aa.</p>
{% include audio_embed.html src="/assets/audio/Aa.mp3" %}

<br> <p>Bb</p>
{% include audio_embed.html src="/assets/audio/Bb.mp3" %}

<p>Cc</p>
{% include audio_embed.html src="/assets/audio/Cc.mp3" %}

<p>Dd</p>
{% include audio_embed.html src="/assets/audio/Dd.mp3" %}

<p>Ee</p>
{% include audio_embed.html src="/assets/audio/Ee.mp3" %}

<p>Ff</p>
{% include audio_embed.html src="/assets/audio/Ff.mp3" %}

<p>Gg</p>
{% include audio_embed.html src="/assets/audio/Gg.mp3" %}

<p>Hh</p>
{% include audio_embed.html src="/assets/audio/Hh.mp3" %}

<p>Ii</p>
{% include audio_embed.html src="/assets/audio/Ii.mp3" %}

<p>Jj</p>
{% include audio_embed.html src="/assets/audio/Jj.mp3" %}

<p>Kk</p>
{% include audio_embed.html src="/assets/audio/Kk.mp3" %}

<p>Ll</p>
{% include audio_embed.html src="/assets/audio/Ll.mp3" %}

<p>Mm</p>
{% include audio_embed.html src="/assets/audio/Mm.mp3" %}

<p>Nn</p>
{% include audio_embed.html src="/assets/audio/Nn.mp3" %}

<p>Oo</p>
{% include audio_embed.html src="/assets/audio/Oo.mp3" %}

<p>Pp</p>
{% include audio_embed.html src="/assets/audio/Pp.mp3" %}

<p>Qq</p>
{% include audio_embed.html src="/assets/audio/Qq.mp3" %}

<p>Rr</p>
{% include audio_embed.html src="/assets/audio/Rr.mp3" %}

<p>Ss</p>
{% include audio_embed.html src="/assets/audio/Ss.mp3" %}

<p>Tt</p>
{% include audio_embed.html src="/assets/audio/Tt.mp3" %}

<p>Uu</p>
{% include audio_embed.html src="/assets/audio/Uu.mp3" %}

<p>Vv</p>
{% include audio_embed.html src="/assets/audio/Vv.mp3" %}

<p>Ww</p>
{% include audio_embed.html src="/assets/audio/Ww.mp3" %}

<p>Xx</p>
{% include audio_embed.html src="/assets/audio/Xx.mp3" %}

<p>Yy</p>
{% include audio_embed.html src="/assets/audio/Yy.mp3" %}

<p>Zz</p>
{% include audio_embed.html src="/assets/audio/Zz.mp3" %}
